                    ...
                    <div class="menu_block">
                        <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                            <ul class="sf-menu">
                                ...
                                <li class="current"><a href="ViewPackage.jsp">View Package</a></li>
                    ...
                    <table style="width: 200%;border: #000" >
                        ...
                        <tbody>
                            <%
                                ...
                                PreparedStatement ps = con.prepareStatement("select * from package order by id desc");
                        ...
                        <td><center><%=rs.getDate(8)%> / <%=rs.getTime(8)%></center></td>
                    <td><center> <img src="ImageRetrive?id=<%=rs.getString(1)%>" width="50"></center></td>
                    <td><center><a href="DeletePackage?id=<%=rs.getString(1)%>">delete</a> </center></td>
