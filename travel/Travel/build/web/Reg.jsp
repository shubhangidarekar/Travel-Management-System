                    ...
                    <div class="menu_block">
                        <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                            <ul class="sf-menu">
                                ...
                                <li><a href="contactus.jsp">Register</a></li>
                                <li class="current"><a href="Reg.jsp">Contact us</a></li>
                ...
                <form  action="reg1" method="post" enctype="multipart/form-data">
                    <div id="form" class="grid_6 prefix_1">
                        ...
                        <label class="Password">
                            <input type="password" placeholder="Password:" name="Password" data-constraints="@Required @JustLetters" required=""/>
                            <span class="empty-message">*This field is required.</span>
                            <span class="error-message">*The message is too short.</span>
                        </label>
                        <label class="file">
